...
export default function Home() {
  ...
  useEffect(() => {
    setMounted(true);
    const currentTheme = (typeof window !== 'undefined' && localStorage.getItem('sk_shop_active_theme')) || 'light';
    ...
    <BrowserRouter>
      <div className="relative min-h-screen w-full overflow-x-hidden transition-colors duration-300 bg-[#F8F4E8] text-[#09090B]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          ...
          <div className="absolute bottom-[-10%] left-[15%] w-[500px] h-[500px] bg-[#f97316]/30 rounded-full blur-[120px] mix-blend-screen animate-breathe-3" />
